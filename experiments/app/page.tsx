        ...
        <div className="bg-[#151515] rounded-2xl p-8 border border-[#222222]">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#666666]">
                  Set credentials for the REST API plugin
                </p>
              </div>
            </div>
            <p className="text-[#888888] text-sm">
              These credentials will be used by the Server Manager to
              communicate with your Hytale server via the REST API plugin. The
          ...
          <div className="mt-6 pt-6 border-t border-[#222222]">
            <p className="text-[#666666] text-xs text-center">
              These credentials are saved locally and shared with your Hytale
              server container. The server will automatically configure the API
              plugin on next restart.
            </p>
          </div>
        </div>
      </div>
...
export default function Dashboard() {
  ...
  const serverAction = async (
    action: "start" | "stop" | "restart" | "save",
  ) => {
    setActionLoading(action);
    try {
      const endpoint =
        action === "save" ? "/api/world/save" : `/api/server/${action}`;
  ...
  const getPlayerCountFromLogs = () => {
    ...
    const joinMatches =
      logs.match(/\[INFO\].*player.*joined|connected/gi) || [];
    const leaveMatches =
      logs.match(/\[INFO\].*player.*left|disconnected/gi) || [];
    ...
    <div className="min-h-screen text-white p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <header className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`w-3 h-3 rounded-full animate-pulse ${status?.online ? "bg-emerald-500" : "bg-red-500"}`}
              />
          ...
          <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() =>
                      updateConfig({ containerName: editContainerName })
                    }
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() =>
                      updateConfig({ adapterType: editAdapterType })
                    }
            ...
            {editAdapterType === "rest" && (
              <div className="border-t border-[#222222] pt-4 mt-4">
                <h3 className="text-sm font-semibold text-[#888888] mb-4">
                ...
                {setupStatus?.setupComplete && (
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3 mb-4 flex items-center gap-2">
                    ...
                    <span className="text-emerald-400 text-sm">
                      API credentials configured (Client ID:{" "}
                      {setupStatus.apiClientId || editRestApiClientId})
                    </span>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditRestApiClientSecret(e.target.value)
                      }
                      placeholder="Enter new password to change"
                      className="w-full bg-[#0d0d0d] border border-[#333333] rounded-lg px-3 py-2 text-white font-mono text-sm focus:outline-none focus:border-[#555555]"
                    />
                    <p className="text-[#555555] text-xs mt-2">
                      Changing the password requires restarting the Hytale
                      server to apply
                    </p>
                  </div>
                    ...
                    {editRestApiClientSecret && (
                      <button
                        onClick={async () => {
                          if (
                            !confirm(
                              "Changing the API password requires restarting the Hytale server. Continue?",
                            )
                          )
                            return;
                          ...
                          if (data.success) {
                            setEditRestApiClientSecret("");
                            alert(
                              "Password changed! Restart the Hytale server to apply.",
                            );
                          } else {
            ...
            <div className="border-t border-[#222222] pt-4 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-mono text-[#a1a1a1]">
                    {config?.serverHost || "N/A"}:{config?.serverPort || 5520}
                  </span>
                </div>
                <div>
                  <span className="text-[#666666]">State Dir:</span>
                  <span className="ml-2 font-mono text-[#a1a1a1] truncate">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[#888888] mb-4">
                  The server is waiting for you to authenticate. Click the
                  button below or visit the URL manually.
                </p>
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="text-[#888888]">
                    Code:{" "}
                    <code className="bg-[#0d0d0d] px-2 py-1 rounded font-mono text-white border border-[#333333]">
                      {authPrompt.code}
                    </code>
                  </div>
                </div>
            ...
            <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-[#666666] text-xs uppercase tracking-wide">
                      State
                    </div>
                ...
                <div>
                  ...
                  <div className="font-medium truncate text-[#a1a1a1]">
                    {status?.name || "N/A"}
                  </div>
                </div>
                <div>
                  ...
                  <div className="font-mono text-sm text-[#a1a1a1]">
                    {status?.version || "N/A"}
                  </div>
                </div>
                <div>
                ...
                {status?.memory && (
                  <div>
                    ...
                    <div className="font-medium">
                      <span className="text-white">
                        {formatMemory(status.memory.used)}
                      </span>
                      <span className="text-[#666666]">
                        {" "}
                        / {formatMemory(status.memory.max)}
                      </span>
                    </div>
                  </div>
                )}
            ...
            <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  disabled={
                    actionLoading !== null || status?.state === "running"
                  }
                ...
                <div className="text-[#666666] text-sm space-y-2">
                  ...
                  {config?.adapterType !== "rest" && (
                    <p className="text-[#555555] text-xs">
                      💡 Switch to REST adapter in Config for player names and
                      details
                    </p>
                  )}
                  {config?.adapterType === "rest" &&
        ...
        <footer className="text-center text-[#555555] text-sm pt-4 border-t border-[#222222]">
          HyOS Server Manager • Adapter: Console • Polling: 2s (logs) / 5s
          (status)
        </footer>
      </div>
    </div>
