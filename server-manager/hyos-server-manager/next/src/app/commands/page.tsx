...
export default function CommandsPage() {
  ...
  const [whitelistAction, setWhitelistAction] = useState<'add' | 'remove' | 'enable' | 'disable'>('add');
  ...
  const handleKick = async () => {
    ...
    const data = await apiPost(`/api/player/${selectedPlayer}/kick`, { reason: kickReason || undefined });
    showResult(data);
    setKickReason('');
    fetchPlayers();
  ...
  const handleBroadcast = async () => {
    ...
    const data = await apiPost('/api/world/broadcast', { message: broadcastMessage });
    showResult(data);
    setBroadcastMessage('');
    setActionLoading(null);
  };
  ...
  const handleSetGameMode = async () => {
    ...
    const data = await apiPost(`/api/player/${selectedPlayer}/gamemode`, { gameMode });
    showResult(data);
    setActionLoading(null);
  };
  ...
  const handleClearInventory = async () => {
    ...
    const data = await apiPost(`/api/player/${selectedPlayer}/inventory/clear`, {
  ...
  const handleSendMessage = async () => {
    ...
    const data = await apiPost(`/api/player/${selectedPlayer}/message`, { message: privateMessage });
    showResult(data);
    setPrivateMessage('');
    setActionLoading(null);
  };
  ...
  const handleGrantPermission = async () => {
    ...
    const data = await apiPost(`/api/player/${selectedPlayer}/permissions`, { permission });
    showResult(data);
    setPermission('');
    setActionLoading(null);
  };
  ...
  const handleAddToGroup = async () => {
    ...
    const data = await apiPost(`/api/player/${selectedPlayer}/groups`, { group: groupName });
    showResult(data);
    setGroupName('');
    setActionLoading(null);
  };
  ...
  const handleSetTime = async () => {
    ...
    const data = await apiPost(`/api/world/${selectedWorld}/time`, { time: parseInt(worldTime) });
    showResult(data);
    setActionLoading(null);
  };
  ...
  const handleSetWeather = async () => {
    ...
    const data = await apiPost(`/api/world/${selectedWorld}/weather`, { weather: worldWeather });
    showResult(data);
    setActionLoading(null);
  };
  ...
  const handleWhitelist = async () => {
    ...
    const players = whitelistPlayers.split(',').map((p) => p.trim()).filter(Boolean);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <header className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[#666666] mt-1">Full control over your Hytale server</p>
          </div>
          <Link
            href="/"
        ...
        {result && (
          ...
          >
            ...
            <div className="text-sm mt-1 opacity-80">
              {result.message || result.output || result.error || 'Action completed'}
            </div>
          </div>
        )}
        ...
        <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
          ...
          {players.length === 0 ? (
            <p className="text-[#666666]">No players online. Some commands require a player to be selected.</p>
          ) : (
            <select
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
            ...
            <div className="mb-6 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Execute Raw Command</label>
            ...
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Kick Player</label>
              <input
                type="text"
                value={kickReason}
            ...
            {/* Ban */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Ban Player</label>
            ...
            {/* Mute */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Mute Player</label>
              <div className="grid grid-cols-2 gap-2 mb-2">
                <input
                  type="text"
                  value={muteReason}
            ...
            <div className="p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Broadcast Message</label>
              <input
                type="text"
          ...
          <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
            ...
            {/* Teleport */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Teleport Player</label>
              ...
              <select
                ...
                className="w-full bg-[#0d0d0d] border border-[#333333] rounded-lg px-3 py-2 text-white text-sm mb-2 focus:outline-none focus:border-[#555555]"
              >
                <option key="same-world" value="">Same world</option>
                {worlds.map((w) => (
                  <option key={`tp-${w.uuid}`} value={w.name}>{w.name}</option>
                ))}
              </select>
              <button
            ...
            {/* Game Mode */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Set Game Mode</label>
              <div className="flex gap-2">
                <select
                  value={gameMode}
                ...
                >
                  ...
                  <option key="creative" value="creative">Creative</option>
            ...
            {/* Give Item */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Give Item</label>
              <div className="grid grid-cols-3 gap-2 mb-2">
                <input
                  type="text"
                  value={giveItemId}
              ...
              <button
                ...
                disabled={actionLoading === 'give' || !selectedPlayer || !giveItemId}
            ...
            {/* Clear Inventory */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Clear Inventory</label>
              <div className="flex gap-2">
                <select
                  value={clearSection}
                ...
                >
                  ...
                  <option key="hotbar" value="hotbar">Hotbar</option>
            ...
            {/* Send Message */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Send Private Message</label>
              <div className="flex gap-2">
                <input
                  type="text"
                ...
                <button
                  ...
                  disabled={actionLoading === 'message' || !selectedPlayer || !privateMessage}
                  className="px-4 py-2 bg-[#333333] hover:bg-[#444444] disabled:opacity-50 rounded-lg font-medium text-sm transition"
                >
            ...
            {/* Permissions */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Grant Permission</label>
              <div className="flex gap-2">
                <input
                  type="text"
                  value={permission}
                ...
                <button
                  ...
                  disabled={actionLoading === 'permission' || !selectedPlayer || !permission}
                  className="px-4 py-2 bg-white text-[#0d0d0d] hover:bg-[#e5e5e5] disabled:opacity-50 rounded-lg font-medium text-sm transition"
                >
            ...
            {/* Groups */}
            <div className="p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Add to Group</label>
              <div className="flex gap-2">
                <input
                  type="text"
                  value={groupName}
                ...
                <button
                  ...
                  disabled={actionLoading === 'group' || !selectedPlayer || !groupName}
                  className="px-4 py-2 bg-white text-[#0d0d0d] hover:bg-[#e5e5e5] disabled:opacity-50 rounded-lg font-medium text-sm transition"
                >
          ...
          <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
            ...
            {/* World Selector */}
            <div className="mb-4">
              <label className="block text-[#888888] text-sm mb-2">Select World</label>
              <select
                value={selectedWorld}
              ...
              >
                {worlds.length === 0 ? (
                  <option key="no-worlds" value="">No worlds available</option>
                ) : (
                  worlds.map((w) => (
                    <option key={w.uuid} value={w.uuid}>{w.name} ({w.type})</option>
                  ))
                )}
              </select>
            </div>
            ...
            {/* Set Time */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Set World Time</label>
              <div className="flex gap-2 mb-2">
                ...
                <button
                  ...
                  disabled={actionLoading === 'time' || !selectedWorld || !worldTime}
                  className="px-4 py-2 bg-white text-[#0d0d0d] hover:bg-[#e5e5e5] disabled:opacity-50 rounded-lg font-medium text-sm transition"
                >
            ...
            {/* Set Weather */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Set Weather</label>
              <div className="flex gap-2">
                <select
                  value={worldWeather}
                ...
                >
                  ...
                  <option key="thunder" value="thunder">Thunder</option>
                </select>
                <button
            ...
            {/* Set Block */}
            <div className="p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Set Block</label>
              <div className="grid grid-cols-3 gap-2 mb-2">
                <input
                  type="number"
                  value={blockX}
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={actionLoading === 'block' || !selectedWorld || !blockX || !blockY || !blockZ || !blockId}
          ...
          <section className="bg-[#151515] rounded-2xl p-6 border border-[#222222]">
            ...
            {/* Save */}
            <div className="mb-4 p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Save Server</label>
              <button
                onClick={handleSave}
            ...
            {/* Whitelist */}
            <div className="p-4 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a]">
              <label className="block text-[#888888] text-sm mb-2">Manage Whitelist</label>
              {whitelist && (
                <div className="mb-3 p-2 bg-[#0d0d0d] rounded text-sm border border-[#222222]">
                  <span className={whitelist.enabled ? 'text-emerald-400' : 'text-[#666666]'}>
                    {whitelist.enabled ? 'Enabled' : 'Disabled'}
                  </span>
                  <span className="text-[#666666] ml-2">
                    ({whitelist.playerCount} player{whitelist.playerCount !== 1 ? 's' : ''})
                  </span>
                </div>
              )}
              <div className="flex gap-2 mb-2">
                <select
                  ...
                  className="bg-[#0d0d0d] border border-[#333333] rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-[#555555]"
                >
                  <option key="add" value="add">Add Players</option>
                  <option key="remove" value="remove">Remove Players</option>
              ...
              <button
                ...
                disabled={
                  ...
                  ((whitelistAction === 'add' || whitelistAction === 'remove') && !whitelistPlayers)
                }
