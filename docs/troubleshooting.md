...
1. Increase `JAVA_XMX` (see [Memory Sizing Guidelines](configuration.md#memory-sizing-guidelines))
...
See [Content-Only Mod Patching](mods-and-plugins.md#content-only-mod-patching) for details.
