...
const SLIDES = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Admin, player, and world commands",
      "Raw command input support",
    ],
  },
  {
    ...
    bullets: [
      "Browse and install mods from providers",
      "Upload custom mod JARs",
  ...
  },
  {
    ...
    bullets: [
      "Upload and manage world files",
      "Browse world directory structure",
      "Switch between world slots",
    ],
  },
  {
    ...
    title: "Configuration",
    bullets: [
      "Edit server configuration via UI",
