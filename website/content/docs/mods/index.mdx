---
title: "Mods & Plugins"
description: "Guide to installing, managing, and creating mods for Hytale servers"
---
...
curl -X POST http://localhost:30381/mods/{mod-id}/patch \
...
| `API_PORT` | `30381` | HTTP listen port |
