...
For security-specific analysis of token storage permissions, auto-refresh behavior, and CI/CD token injection caveats, see the [Security — Hytale Platform OAuth](/docs/security/authentication#hytale-platform-oauth) documentation.
