...
description: "Deploy HyOS on TrueNAS SCALE using native apps or Docker Compose"
---
...
4. **Paste the contents of the `compose.yaml` from `hytale-docker-server/config-truenas/`**
