...
| Variable | Type | Default | Description |
|----------|------|---------|-------------|
| `JAVA_XMS` | string | `1G` | Initial heap size. |
| `JAVA_XMX` | string | `3G` | Maximum heap size. Set to 50-75% of available RAM. |
...
| `API_PORT` | integer | `30381` | HTTP port for the API. |
...
| `API_WEBSOCKET_STATUS_INTERVAL` | integer | `5` | WebSocket status broadcast interval in seconds. |
