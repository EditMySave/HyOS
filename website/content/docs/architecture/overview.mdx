...
description: "System architecture, container topology, data flow, and state management"
---
...
graph LR
    ...
    subgraph Docker["Docker Host"]
        ...
        HS --- API
        MGR -- "HTTP 30381<br/>REST API" --> API
...
|-----------|---------------|----------|---------|-------------|
| 30380 | 5520 | UDP | Hytale Server | QUIC game traffic (player connections) |
| 30381 | 30381 | TCP | API Plugin | REST API for server management |
| 30382 | 3000 | TCP | HyOS Manager | Web UI dashboard |
...
> For comprehensive security documentation including authentication details, production hardening, and known limitations, see [Security](/docs/security).
